...
<div class="container">
	...
	<!-- 
		...
		resources 폴더를 제공한다. 해당 폴더의 매핑은 sevlet-context.xml
		에서 변경할 수 있다.
	 -->
	<h3>resources 폴더 사용하기</h3>
	<img src="./4.png" alt="강아지"/> <!-- 이미지 출력되지 않음. -->
	<!--  
		원래의 폴더명은 resources이나 아래 images와 같은
		이름으로 매핑명을 변경할 수 있다.
	-->
	...
	<li>
		<a href="./form/commandObjGet.do?id=kosmo&pw=1234
			&name=홍길동&email=hong@gildong.com" target="_blank">
			커맨드(Command) 객체로 한번에 폼 값 받기
		</a>
	</li>
	
	<li>
		<a href="./form/gildong99/코스모" target="_blank">
			PathVariable 어노테이션으로 폼 값 받기
		</a>
	</li>
