...
public class RequestMappingController {
	...
	ModelAndView 객체
		...
		-model 객체에 데이터 저장 : 참조변수.adObject("속성명", "속성값")
		최종적으로 뷰를 호출할 때는 ModelAndView 참조변수를 return 한다.
	 */
	...
	public ModelAndView postLogin(
		...
		mv.addObject("pw",pw);
		/*
		ModelAndView 객체를 반환하여 뷰를 호출한다. 해당 메소드의
		반환타입도 해당 객체타입으로 지정한다.
		 */
		return mv;
	...
	@ModelAttribute 어노테이션
		: 뷰로 전달되는 커맨드 객체의 이름을 임의로 변경하고 싶을 때
